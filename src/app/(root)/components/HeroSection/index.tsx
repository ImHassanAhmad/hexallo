...
export default function HeroSection() {
  ...
  return (
    <section
      className="w-full px-[42px] sm:px-6 md:px-8 lg:px-16 py-6"
      aria-label="Hero"
    >
      ...
      <div className="relative w-full rounded-3xl overflow-hidden shadow-lg border border-white/20 min-h-[570px]">
        ...
        <div className="absolute inset-0 z-10 flex flex-col items-center justify-center px-4 sm:px-6 md:px-8 pt-12 pb-24">
          ...
          {/* Search bar */}
          <div className="border-b-[1.75px] border-[#E3E3E1] mt-8 w-full max-w-4xl flex flex-col sm:flex-row gap-2 sm:gap-3 sm:h-[37px] p-0 bg-white rounded-[12px] shadow-xl items-center">
